...
# Now running iteration 1 with a sample size of 1500 
# Number of cross-validation folds is 10 
#         N  glm0 glm_strat0 AIPW_strat0 TMLE_strat0 AIPW_auto0 TMLE_auto0  glm1 glm_strat1
# bias  1500 0.181      0.114       0.070       0.069     -0.097     -0.058 0.038      0.116
# rmse  1500 0.033      0.013       0.005       0.005      0.009      0.003 0.001      0.014
# cov   1500 1.000      1.000       1.000       1.000        NaN        NaN 1.000      1.000
# width 1500 1.624      1.618       1.588       1.588        NaN        NaN 1.789      2.054
# AIPW_strat1 TMLE_strat1 AIPW_auto1 TMLE_auto1
# bias        0.032       0.032      0.130      0.099
# rmse        0.001       0.001      0.017      0.010
# cov         1.000       1.000        NaN        NaN
# width       2.095       2.090        NaN        NaN
# 
